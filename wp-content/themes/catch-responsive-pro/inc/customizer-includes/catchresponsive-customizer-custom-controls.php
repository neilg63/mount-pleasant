...
if ( ! defined( 'CATCHRESPONSIVE_THEME_VERSION' ) ) {
	...
	class catchresponsive_Customize_Dropdown_Categories_Control extends WP_Customize_Control {
		...
		public function render_content() {
			...
			echo '<p class="description">'. __( 'Hold down the Ctrl (windows) / Command (Mac) button to select multiple options.', 'catch-responsive-pro' ) . '</p>';
		}
	}


	//Custom control for any note, use label as output description
	class catchresponsive_Note_Control extends WP_Customize_Control {
        ...
        public function render_content() {
            ...
            $important_links = array(
							'theme_instructions' => array(
								'link'	=> esc_url( 'https://catchthemes.com/theme-instructions/catch-responsive-pro/' ),
								'text' 	=> __( 'Theme Instructions', 'catch-responsive-pro' ),
								),
							'support' => array(
								'link'	=> esc_url( 'https://catchthemes.com/support/' ),
								'text' 	=> __( 'Support', 'catch-responsive-pro' ),
								),
							'changelog' => array(
								'link'	=> esc_url( 'https://catchthemes.com/changelogs/catch-responsive-pro-theme/' ),
								'text' 	=> __( 'Changelog', 'catch-responsive-pro' ),
								),
							'facebook' => array(
								'link'	=> esc_url( 'https://www.facebook.com/catchthemes/' ),
								'text' 	=> __( 'Facebook', 'catch-responsive-pro' ),
								),
							'twitter' => array(
								'link'	=> esc_url( 'https://twitter.com/catchthemes/' ),
								'text' 	=> __( 'Twitter', 'catch-responsive-pro' ),
								),
							'gplus' => array(
								'link'	=> esc_url( 'https://plus.google.com/+Catchthemes/' ),
								'text' 	=> __( 'Google+', 'catch-responsive-pro' ),
								),
							'pinterest' => array(
								'link'	=> esc_url( 'http://www.pinterest.com/catchthemes/' ),
								'text' 	=> __( 'Pinterest', 'catch-responsive-pro' ),
								),
							);
