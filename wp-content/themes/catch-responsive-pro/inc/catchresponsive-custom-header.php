...
if ( ! function_exists( 'catchresponsive_featured_image_display' ) ) :
	...
	function catchresponsive_featured_image_display() {
		...
		if ( "before-header" == $options['featured_header_image_position']  ) {
			add_action( 'catchresponsive_header', 'catchresponsive_featured_overall_image', 20 );
		}
		elseif ( "after-slider" == $options['featured_header_image_position'] ) {
			add_action( 'catchresponsive_before_content', 'catchresponsive_featured_overall_image', 20 );
		}
		...
		elseif ( "before-menu" == $options['featured_header_image_position'] ) {
			add_action( 'catchresponsive_after_header', 'catchresponsive_featured_overall_image', 10 );
		}
