...
class CatchResponsiveMetaBox {
	...
	*/
	public function __construct( $meta_box_id, $meta_box_title, $post_type ) {
		...
		$this->fields = array(
								...
								'catchresponsive-sidebar-options',
	...
	*/
	public function show() {
		...
		$sidebar_options		= catchresponsive_metabox_sidebar_options();
	    ...
	    <div id="catchresponsive-ui-tabs" class="ui-tabs">
		    <ul class="catchresponsive-ui-tabs-nav" id="catchresponsive-ui-tabs-nav">
		    	<li><a href="#frag1"><?php _e( 'Layout Options', 'catch-responsive-pro' ); ?></a></li>
		    	<li><a href="#frag2"><?php _e( 'Select Sidebar', 'catch-responsive-pro' ); ?></a></li>
		    	<li><a href="#frag3"><?php _e( 'Header Featured Image Options', 'catch-responsive-pro' ); ?></a></li>
		    	<li><a href="#frag4"><?php _e( 'Single Page/Post Image Layout ', 'catch-responsive-pro' ); ?></a></li>
		    </ul>
...
$catchresponsive_metabox = new CatchResponsiveMetaBox(
									...
									__( 'Catch Responsive Options', 'catch-responsive-pro' ), //metabox title
