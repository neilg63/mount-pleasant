...
<?php
	 ...
	 * @hooked catchresponsive_featured_overall_image (before-header) - 20
	 * @hooked catchresponsive_header_start- 30
	 * @hooked catchresponsive_mobile_header_nav_anchor - 40
     ...
     *
     * @hooked catchresponsive_featured_overall_image (before-menu) - 10
     * @hooked catchresponsive_primary_menu - 20
     * @hooked catchresponsive_secondary_menu - 30
     * @hooked catchresponsive_featured_overall_image (after-menu) - 40
	 ...
	 * @hooked catchresponsive_featured_overall_image (after-slider)  - 20
	...
	/**
     * catchresponsive_main hook
     *
     *  @hooked catchresponsive_content_start - 10
     *  @hooked catchresponsive_add_breadcrumb - 20
     *  @hooked catchresponsive_sidebar_secondary (three-columns-secondary-sidebar-first) - 30
