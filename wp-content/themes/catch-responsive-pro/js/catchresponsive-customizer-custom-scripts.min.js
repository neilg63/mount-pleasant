...
( function( api ) {
    wp.customize( 'catchresponsive_theme_options[reset_typography]', function( setting ) {
        setting.bind( function( value ) {
            ...
            if ( value ) {
                setting.notifications.add( code, new wp.customize.Notification(
                    ...
                    {
                        type: 'info',
                        message: catchresponsive_data.reset_message
                    }
                ) );
            } else {
    ...
    wp.customize( 'catchresponsive_theme_options[reset_footer_content]', function( setting ) {
        setting.bind( function( value ) {
            var code = 'needs_refresh';
            if ( value ) {
                setting.notifications.add( code, new wp.customize.Notification(
        ...
        ready: function() {
            if ( 'catchresponsive_theme_options[color_scheme]' === this.id ) {
                this.setting.bind( 'change', function( color_scheme ) {
                    jQuery.each( catchresponsive_data.catchresponsive_color_list, function( index, value ) {
